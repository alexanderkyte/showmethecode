## note to self, write out the BNF form of the math you're expecting.

def derivativeMaker(f, precision):
# the derivative
    def derivative(x):
        
        eturn (f(x+precision) - f(x))/(precision)
    return derivative

def integral(f, lower, upper):
